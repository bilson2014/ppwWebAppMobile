...
<body>
	...
	<div class='first'>
   	...
   	<div class='biao'>
   		...
   		<a href='/resources/salesman/indexs.html'>更多   <img src="${imgPath}/salesMan/special/index/more.png" alt="更多"/> </a>
   	</div>
   	...
   	<div class='hots'>
   		<div class="swiper-container">
			<div class="swiper-wrapper">
	    		<div class="swiper-slide">
		    		<a href='channel01.html'><img src="${imgPath}/salesMan/special/index/page1.png" alt="区块链"/></a>  
	        	</div>
	        	<div class="swiper-slide">
					<a href='channel02.html'><img src="${imgPath}/salesMan/special/index/page2.png" alt="互联网金融"/></a>
	        	</div>
	        	<div class="swiper-slide">
		    		<a href='channel03.html'><img src="${imgPath}/salesMan/special/index/page3.png" alt="发布会"/></a>  
	        	</div>
	        	<div class="swiper-slide">
					<a href='channel04.html'><img src="${imgPath}/salesMan/special/index/page4.png" alt="投资"/></a>
	        	</div>
	        	<div class="swiper-slide">
		    		<a href='channel05.html'><img src="${imgPath}/salesMan/special/index/page5.png" alt="医美"/></a>  
	        	</div>
	    	</div>
   		</div>
